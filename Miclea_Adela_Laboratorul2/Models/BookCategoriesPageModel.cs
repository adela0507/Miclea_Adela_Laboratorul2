...
namespace Miclea_Adela_Laboratorul2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
       public List<AssignedCategoryData>? AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Miclea_Adela_Laboratorul2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Miclea_Adela_Laboratorul2Context context,
